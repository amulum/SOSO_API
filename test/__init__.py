...
def reset_db():
    ...
    # create product
    item_1 = Product(1,1,1, 'Fit Me! Matte Foundation', 'Fit Me! Matte Foundation', 149000, 40, 89400, 1,'imagepath')
    item_2 = Product(1,1,1, 'Radiance Foundation', 'Radiance Foundation', 149000, 0, 149000, 3,'imagepath')
    item_3 = Product(1,1,1, 'Stay matte not Flat', 'Stay matte not Flat', 160000, 30, 112000, 3,'imagepath')
    item_4 = Product(4,1,24, 'Baby Daily Lotion', 'Shower Gel Lavender', 160000, 0, 160000, 3,'imagepath')
    item_5 = Product(4,1,24, 'Experience Body Foam', 'Baby Bath & Wash', 52000, 50, 26000, 3,'imagepath')
    item_6 = Product(1,1,6, 'BB Cream Beauty Bliss Natural', 'Natural Shade', 26000, 10, 23400, 5,'imagepath')
    item_7 = Product(1,1,6, 'BB Cream Beauty Bliss Light', 'Light Shade', 26000, 10, 23400, 5,'imagepath')
    item_8 = Product(1,1,6, 'BB Cream Beauty Bliss Caramel', 'Caramel Shade', 26000, 10, 23400, 5,'imagepath')
    item_9 = Product(2,1,1, 'Ms Pimple Moist Gel', 'Moist Gel', 50000, 40, 30000, 5,'imagepath')
    item_10 = Product(2,1,3, 'Ms Pimple Face Tonic', 'Face Tonic', 50000, 40, 30000, 5,'imagepath')
