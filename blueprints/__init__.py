...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:jg46!32B@0.0.0.0:3306/portfolio' if (
    env == 'testing') else 'mysql+pymysql://root:jg46!32B@portfoliotest.cfhv9cr80uiw.ap-southeast-1.rds.amazonaws.com:3306/portfoliotest'
# except Exception as e:
#     raise e
# 'mysql+pymysql://root:jg46!32B@0.0.0.0:3306/portfolio_test'
# 'mysql+pymysql://root:jg46!32B@portfoliotest.cfhv9cr80uiw.ap-southeast-1.rds.amazonaws.com:3306/portfoliotest'
